 ...
 * @author Nusrat
 */
public class NgoDetials extends javax.swing.JFrame {

    /**
     * Creates new form NgoDetials
     */
    public NgoDetials() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ngo information");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NgoDetials.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NgoDetials().setVisible(true);
            }
        });
    }
